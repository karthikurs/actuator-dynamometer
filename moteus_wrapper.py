...
async def init_controllers():
    ...
    cmd1 = "python3 -m moteus.moteus_tool --target 1 --pi3hat-cfg '1=1;2=2' --restore-cal " + cal_file_1
    cmd2 = "python3 -m moteus.moteus_tool --target 2 --pi3hat-cfg '1=1;2=2' --restore-cal " + cal_file_2
    print(cmd1)        
    os.system(cmd1)
    print(cmd2)
    os.system(cmd2)
